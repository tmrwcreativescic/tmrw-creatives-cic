...
export function NewsCard({
  ...
  if (featured) {
    return (
      <Link href={href} className="block col-span-full lg:col-span-2 row-span-2">
        <Card className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 bg-white h-full">
          <div className="grid md:grid-cols-2 h-full">
            ...
            <CardContent className="p-8 flex flex-col justify-center">
              ...
              <span className="inline-flex items-center text-tmrw-purple font-accent font-bold hover:gap-3 gap-2 transition-all">
    ...
    <Link href={href} className="block">
      <Card className="group overflow-hidden border-0 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 bg-white h-full">
        ...
        <CardContent className="p-6">
          ...
          <span className="inline-flex items-center text-tmrw-purple font-accent font-bold text-sm group-hover:gap-3 gap-2 transition-all">
            Read More <ArrowRight className="h-4 w-4" />
          </span>
        </CardContent>
      </Card>
